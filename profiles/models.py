...
class StudentProfile(models.Model):
    ...
    batch_year = models.DateField(null=True)
    ...
    skills = models.ManyToManyField(
        "achievements.Skill", related_name="students", blank=True
    )
...
class FacultyProfile(models.Model):
    ...
    designation = models.CharField(
        max_length=50, choices=Designation.choices, default=Designation.ASST_PROF
    )
