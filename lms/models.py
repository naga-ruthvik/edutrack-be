...
# =============================================================================
# 2. PUBLIC SCHEMA TABLES (Shared across ALL tenants)
# =============================================================================

class Institution(models.Model):
    """
    PUBLIC SCHEMA ONLY - Maps each tenant to its Edlink integration
    Table lives in 'public' schema, accessed by cron jobs
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(max_length=255)  # "Vardhaman College of Engineering"
    
    schema_name = models.CharField(max_length=63, unique=True)  # "vardhaman"
    
    # Edlink credentials (cron jobs use these)
    ...
    class Meta:
        db_table = 'lms_institution'  # Forces public schema table name
