...
from .views import GenerateResumeAPIView, UpdateResumeAPIView, AnalyzeResumeAPIView, ResumeAPIView, ListResumeAPIView, list_student_data
urlpatterns = [
    ...
    path('student/data/', list_student_data, name='list-student-data'),
]